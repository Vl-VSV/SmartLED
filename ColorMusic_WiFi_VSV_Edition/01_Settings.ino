...
#define AUTO_LOW_PASS_ON_START 1 // Это настройка, которая включает автоматическое определение порога шума при запуске. 
// Значение порога можно изменить вручную, нажав кнопку «ОК», и новое значение сохранится в памяти.

#define LED_COLOR_ORDER GRB // Эта директива используется для определения порядка следования цветов на ленте. 
// Если цвета на ленте перепутаны, необходимо изменить эту настройку.
